...
describe('Parser', () => {
    ...
    describe('authorization', () => {
        ...
        it('should not match if repository name is not authorized', () => {
            request.body.repository.name = 'UnauthorizedRepo';
            assert.deepEqual(parser(config).parse(request), null);
        });

        it('should not match if repository owner is not authorized', () => {
